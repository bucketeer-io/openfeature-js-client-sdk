...
const API_KEY = process.env.EXPO_PUBLIC_BKT_API_KEY || '';
...
(async () => {
  ...
  // Handle initialization errors to avoid unhandled promise rejections
...
function HomeScreen() {
  const isNewFeatureEnabled = useBooleanFlagValue('new-home-screen', false);
