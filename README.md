...
```
 ...
 > [!NOTE]
 > There is no need to await `setProvider` in React and React Native, because the provider initialization is handled internally by the OpenFeature React SDK.
